...
HD_PWD='D:/Dropbox/dr/mgr/Workspaces/Vivado/CPUv1/CPUv1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lvl.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_lvl.tcl
