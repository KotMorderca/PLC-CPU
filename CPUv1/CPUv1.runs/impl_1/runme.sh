...
HD_PWD='D:/Dropbox/dr/mgr/Workspaces/Vivado/CPUv1/CPUv1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lvl.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_lvl.tcl -notrace
